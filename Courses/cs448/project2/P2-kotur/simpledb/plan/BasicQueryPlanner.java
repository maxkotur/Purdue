...
public class BasicQueryPlanner implements QueryPlanner {
   ...
   public Plan createPlan(QueryData data, Transaction tx) {
     ...
     List<Plan> plans = new ArrayList<>();
      ...
      System.out.println("starting blocks: " + p.blocksAccessed());
      for (Plan nextplan : plans) {
          System.out.println("starting blocks: " + nextplan.blocksAccessed());
         p = new OptimizedProductPlan(p, nextplan, data);
          System.out.println("All blocks: " + p.blocksAccessed());
      }
