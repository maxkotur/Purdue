...
insert into STUDENT values (04181,'Jack',11,'SO',str_to_date('19980108','%Y%m%d'));
insert into STUDENT values (06711,'A.Smith',22,'FR',str_to_date('19951121','%Y%m%d'));
insert into STUDENT values (12341,'Banks',33,'SR',str_to_date('19970503','%Y%m%d'));
insert into STUDENT values (37261,'M.Lee',55,'SO',str_to_date('19931001','%Y%m%d'));
insert into STUDENT values (48291,'Bale',33,'JR',str_to_date('19930127','%Y%m%d'));
insert into STUDENT values (57651,'Lim',11,'SR',str_to_date('19960202','%Y%m%d'));
insert into STUDENT values (00191,'Sharon',22,'FR',str_to_date('19931217','%Y%m%d'));
insert into STUDENT values (73571,'Johnson',11,'JR',str_to_date('19960618','%Y%m%d'));
insert into STUDENT values (80161,'Cho',55,'JR',str_to_date('19920507','%Y%m%d'));
insert into STUDENT values (80162,'Angin',11,'SR',str_to_date('19900815','%Y%m%d'));
...
insert into CLASS values ('HIS21000', str_to_date('13:30','%H:%i'),'L108',1040);
insert into CLASS values ('MATH27500', str_to_date('14:30','%H:%i'),'L108',1050);
insert into CLASS values ('STAT11000', str_to_date('16:30','%H:%i'),'R128',1050);
insert into CLASS values ('PHYS10000', str_to_date('16:30','%H:%i'),'U003',1010);
